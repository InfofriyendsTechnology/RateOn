...
import { LucideAngularModule, User, Mail, Shield, CheckCircle, Building, X, AlertTriangle, Trash2, Palette, Sun, Moon, Bell, Key, ExternalLink, BarChart3, Settings, Eye, EyeOff } from 'lucide-angular';
